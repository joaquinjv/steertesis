...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            Log.i(TAG, getGeofenceTransitionId(triggeringGeofences));
        } else {
            // Log the error.
     ...
     */
    private String getGeofenceTransitionId(List<Geofence> triggeringGeofences) {
        return triggeringGeofences.get(0).getRequestId().split(Constants.GEOFENCE_ID_DELIMITER)[0];
    }
